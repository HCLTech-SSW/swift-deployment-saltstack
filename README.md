...
c)	Execute the ring_distribution.sh file by passing the first argument as name of Salt-Minion for controller nod (i.e. 		controller.mitaka), second argument as name of Salt-Minion for objectstorage node1 (i.e. objectstorage1.mitaka), third 		argument as name of Salt-Minion for objectstorage node2 (i.e. objectstorage2.mitaka) and fourth argument as name of 		Salt-Minion for objectstorage node3 (i.e. objectstorage3.mitaka).
